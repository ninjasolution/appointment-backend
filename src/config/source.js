module.exports = {
	roles: [
		"user", "admin", "client", "member", "supplier"
	],
    categoryType: [
		"product", "service"
	],
    ...
    measures: [
        "Milliliters (ml)", "Liters (l)", "Fluid ounces (Fl. oz.)", "Grams (g)", "Gallons (gal)", "Ounces (oz)", "Pounds (lb)", "Centimeters (cm)", "Feet (ft)", "Inches (in)", "A whole product"
    ]
